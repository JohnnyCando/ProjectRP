...
export class AuthSessionService {
  ...
  updateUser(first_name: string, last_name: string, birth_date: string, email: string, password: string, gender_id: number, nick_name: string, id: number) {
...
// colocar iput de cantidad aproximada con un reflejo del valor calculado que ofrece la empresa en el componenete del listado de las empresas.
  setIdUser(id) {
    let idUsed = id
    localStorage.setItem('idUsedUser', idUsed)
  }
  ...
  logoutUser() {
    ...
    localStorage.removeItem('currentReservation2');
    localStorage.removeItem('currentReservation3');
    localStorage.removeItem('currentReservation4');
